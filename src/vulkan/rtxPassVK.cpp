...
RtxPassVK::RtxPassVK(
    ...
    m_rtx_attachment             (i_rtx_attachment)
{
...
VkCommandBuffer RtxPassVK::draw( const Frame& i_frame)
{
    RendererVK& renderer = *m_runtime.m_renderer;
...
void RtxPassVK::createFbo()
{
    for (size_t i = 0; i < m_fbos.size(); i++)
    {
        ...
        attachments[0] = m_rtx_attachment.m_image_view;
...
void RtxPassVK::createRenderPass()
{
    RendererVK& renderer = *m_runtime.m_renderer;

    std::array<VkAttachmentDescription, 1> attachments = {};
    attachments[ 0 ].format         = m_rtx_attachment.m_format;
...
void RtxPassVK::createPipelines()
{
    RendererVK& renderer = *m_runtime.m_renderer;
...
void RtxPassVK::createDescriptorLayout()
{
    ...
    layout_bindings[ 3 ].descriptorType               = VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR; // tlas
...
void RtxPassVK::createDescriptors()
{
    ...
    {   
        ...
        writeDescriptorSetAccelerationStructure.pAccelerationStructures = &m_runtime.getAccelerationStructure(i);
        ...
        set_write[ 3 ].dstSet            = m_descriptor_sets[i];
        ...
        set_write[ 3 ].pBufferInfo       = nullptr;
