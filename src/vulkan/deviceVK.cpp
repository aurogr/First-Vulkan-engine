...
void DeviceVK::createDevice()
{
    ...
    if (std::find(m_supported_extensions.begin(), m_supported_extensions.end(), VK_KHR_ACCELERATION_STRUCTURE_EXTENSION_NAME) != m_supported_extensions.end())
    {
        m_extensions.push_back(VK_KHR_ACCELERATION_STRUCTURE_EXTENSION_NAME);
        accelerationStructureFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ACCELERATION_STRUCTURE_FEATURES_KHR;
        accelerationStructureFeatures.accelerationStructure = VK_TRUE;
        accelerationStructureFeatures.pNext = pNextChain;
        pNextChain = &accelerationStructureFeatures;
    }
    if (std::find(m_supported_extensions.begin(), m_supported_extensions.end(), VK_KHR_RAY_TRACING_PIPELINE_EXTENSION_NAME) != m_supported_extensions.end())
    {
        m_extensions.push_back(VK_KHR_RAY_TRACING_PIPELINE_EXTENSION_NAME);
        rayTracingPipelineFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_FEATURES_KHR;
        rayTracingPipelineFeatures.rayTracingPipeline = VK_TRUE;
        rayTracingPipelineFeatures.pNext = pNextChain;
        pNextChain = &rayTracingPipelineFeatures;
    }
    if (std::find(m_supported_extensions.begin(), m_supported_extensions.end(), VK_KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME) != m_supported_extensions.end())
    {
    ...
    if (std::find(m_supported_extensions.begin(), m_supported_extensions.end(), VK_KHR_DEFERRED_HOST_OPERATIONS_EXTENSION_NAME) != m_supported_extensions.end())
    {
        m_extensions.push_back(VK_KHR_DEFERRED_HOST_OPERATIONS_EXTENSION_NAME);
    }
    if (std::find(m_supported_extensions.begin(), m_supported_extensions.end(), VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME) != m_supported_extensions.end())
    {
    ...
    if (std::find(m_supported_extensions.begin(), m_supported_extensions.end(), VK_KHR_RAY_QUERY_EXTENSION_NAME) != m_supported_extensions.end())
    {
        m_extensions.push_back(VK_KHR_RAY_QUERY_EXTENSION_NAME);
        rayQueryFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_QUERY_FEATURES_KHR;
        rayQueryFeatures.rayQuery = VK_TRUE;
        rayQueryFeatures.pNext = pNextChain;
        pNextChain = &rayQueryFeatures;
    }

    VkPhysicalDeviceFeatures2 physicalDeviceFeatures2 = {};
    physicalDeviceFeatures2.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
    physicalDeviceFeatures2.features = m_physical_device_features;
    ...
    loadExtensions(m_logical_device, m_renderer.getInstance());
