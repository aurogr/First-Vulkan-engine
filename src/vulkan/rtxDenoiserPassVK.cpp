...
void RtxDenoiserPassVK::shutdown()
{
    RendererVK& renderer = *m_runtime.m_renderer;
...
VkCommandBuffer RtxDenoiserPassVK::draw(const Frame& i_frame)
{
    ...
    UtilsVK::beginRegion(current_cmd, "SSAO Pass", Vector4f(0.5f, 0.0f, 0.0f, 1.0f));
...
void RtxDenoiserPassVK::createFbo()
{
...
void RtxDenoiserPassVK::createRenderPass()
{
    RendererVK& renderer = *m_runtime.m_renderer;
...
void RtxDenoiserPassVK::createPipelines()
{
    RendererVK& renderer = *m_runtime.m_renderer;
...
void RtxDenoiserPassVK::createDescriptors()
{
