...
void main() {
    ...
    out_material        = vec4( 1.0, per_object_data.objects[ f_instance ].m_metallic_roughness.x, per_object_data.objects[ f_instance ].m_metallic_roughness.y, 1.0 ); //0 for diffuse
}