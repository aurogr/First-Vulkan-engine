...
namespace MiniEngine
{
    ...
    public:
        ...
        MiniEngineException(const char* fmt, const Args &...args) : std::runtime_error(tfm::format(fmt, args...))
        {
        }
    };
    ...
    struct Vertex
    {
        ...
        Vertex() : m_position({ 0.0f, 0.0f, 0.0f }), m_normal({ 0.0f, 1.0f, 0.0f }), m_uv({ 0.0f, 0.0f })
        {
        }
    };
    ...
    struct Attachments
    {
        ...
        ImageBlock m_rtx_denoiser_attachment;
    };
